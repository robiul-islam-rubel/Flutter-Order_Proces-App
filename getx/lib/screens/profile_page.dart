...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
          ...
          return Scaffold(
            appBar: CustomAppBar(title: "Profile",height: 55,),
    ...
    return Row(
      children: [
        FxContainer(
          width: 10,
          height: 24,
          color: AppTheme.shoppingManagerTheme.colorScheme.primaryContainer,
          borderRadiusAll: 2,
        ),
        FxSpacing.width(8),
        FxText.titleMedium(
              ...
              child: Row(
                children: [
                  Icon(Icons.work_off_outlined,
                      size: 20,
                      color: AppTheme.shoppingManagerTheme.colorScheme.onPrimaryContainer),
                  FxSpacing.width(8),
          ...
          children: [
            ...
            Row(
              children: [
                FxText.bodySmall(
                  'Action Needed',
                  color: AppTheme.shoppingManagerTheme.colorScheme.error,
                  fontWeight: 600,
                ),
                FxSpacing.width(4),
                Icon(
      ...
      children: [
        ...
        Center(
          child: FxButton.medium(
              ...
              child: FxText(
                'Logout',
                color: AppTheme.shoppingManagerTheme.colorScheme.onErrorContainer,
                fontWeight: 500,
              )),
        )
      ],
